    ...
    <section className="contact">
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className="input-box">
                ...
                <input type="text" className='field' placeholder='Entrer votre Numero de telephone' required />
            </div>
            ...
            <div className="input-box">
                <label> Message : </label>
                <textarea name="Message" className='field mess' id=""placeholder='entrer les details sur votre reservation ou laisser un message'></textarea>
            </div>
